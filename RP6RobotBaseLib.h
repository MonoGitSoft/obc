...
struct permission_state
    {
		uint8_t move:1;
		uint8_t rotate_left:1;
		uint8_t rotate_right:1;
		uint8_t command:1;
		uint8_t stream:1;
		uint8_t unused:3;
	}permission;
...
extern volatile uint16_t mleft_my_speed;
extern volatile uint16_t mright_my_speed;
...
extern volatile uint16_t mleft_dist_pose;
extern volatile uint16_t mright_dist_pose;

extern volatile uint16_t mleft_abs_dist;
extern volatile uint16_t mright_abs_dist;
extern volatile uint16_t mright_dist;
